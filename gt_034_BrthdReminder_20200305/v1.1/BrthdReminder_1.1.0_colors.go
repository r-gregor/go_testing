...
// v1.0.9	(20191119/10/en)	-- corrected func fillData(): thisY -> newY
// v1.1.0	(20200305/11/en)	-- added set into fillData function to remove duplicate entries from ext. file
//
...
var dni int
var danesf = time.Time.Format(danes, "02.01.2006") // v1.0.9
...
func fillData() {
	...
	for scanner.Scan() {
		...
		now, _ := strconv.Atoi(newY)
		then, _ := strconv.Atoi(myy)
